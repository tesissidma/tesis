  ...
  <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                @include('atletas.form.masistencias')
               <br>
               <br>
...
<table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">1</th>
                          <td>25/12/2018</td>
                          <td><button type="button" class="btn btn-xs btn-primary  "  data-toggle="modal" data-target="#exampleModal">ver</button>
                        ...
                        <tr>
                          ...
                          <td>24/12/2018</td>
                          <td>
                            <button type="button" class="btn btn-xs btn-primary  "  data-toggle="modal" data-target="#exampleModal">ver</button>
